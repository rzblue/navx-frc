...
class SimIO implements IIOProvider {
  ...
  public SimIO(byte update_rate_hz, IIOCompleteNotification notify_sink, SimDevice sim_device) {
    ...
    if (sim_device != null) {
      ...
      simCompassHeading =
          sim_device.createDouble("CompassHeading", SimDevice.Direction.kInput, 0.0f);
      simFusedHeading = sim_device.createDouble("FusedHeading", SimDevice.Direction.kInput, 0.0f);

      simLinearWorldAccelX =
          sim_device.createDouble("LinearWorldAccelX", SimDevice.Direction.kInput, 0.0f);
      simLinearWorldAccelY =
          sim_device.createDouble("LinearWorldAccelY", SimDevice.Direction.kInput, 0.0f);
      simLinearWorldAccelZ =
          sim_device.createDouble("LinearWorldAccelZ", SimDevice.Direction.kInput, 0.0f);
    ...
    board_state.cal_status = IMUProtocol.NAV6_CALIBRATION_STATE_COMPLETE;
